  ...
  const renderActivePage = () => {
    if (role === 'student') {
      switch (activePage) {
        ...
        case 'perfil':
          return <StudentPerfil onLogout={handleLogout} />;
        default:
          return <StudentHome onNavigate={handleNavigate} />;
      }
    }
    ...
    if (role === 'teacher') {
      switch (activePage) {
        case 'indicadores':
          return <TeacherIndicadores />;
        case 'turmas':
          return <TeacherTurmas />;
        case 'ranking':
          return <TeacherRanking />;
        case 'perfil':
          return <TeacherPerfil onLogout={handleLogout} />;
        default:
          return <TeacherIndicadores />;
      }
    }
    ...
    if (role === 'manager') {
      switch (activePage) {
        ...
        case 'perfil':
          return <ManagerPerfil onLogout={handleLogout} />;
        default:
          return <ManagerIndicadores />;
      }
    }
